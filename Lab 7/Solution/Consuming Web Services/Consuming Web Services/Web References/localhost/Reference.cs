...
namespace Consuming_Web_Services.localhost {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="AddtoCartSoap", Namespace="http://tempuri.org/")]
    public partial class AddtoCart : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public AddtoCart() {
            this.Url = global::Consuming_Web_Services.Properties.Settings.Default.Consuming_Web_Services_localhost_AddtoCart;
        ...
        /// <remarks/>
        public void AddToCartAsync(string item) {
            this.AddToCartAsync(item, null);
        }
        
        /// <remarks/>
        public void AddToCartAsync(string item, object userState) {
            ...
            this.InvokeAsync("AddToCart", new object[] {
                        item}, this.AddToCartOperationCompleted, userState);
        }
