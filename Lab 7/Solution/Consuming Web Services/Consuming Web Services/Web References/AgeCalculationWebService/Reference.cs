...
namespace Consuming_Web_Services.AgeCalculationWebService {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="AgeCalculationSoap", Namespace="http://tempuri.org/")]
    public partial class AgeCalculation : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public AgeCalculation() {
            this.Url = global::Consuming_Web_Services.Properties.Settings.Default.Consuming_Web_Services_AgeCalculationWebService_AgeCalculation;
        ...
        /// <remarks/>
        public void CalculateAgeAsync(int year, int month, int day) {
            this.CalculateAgeAsync(year, month, day, null);
        }
        
        /// <remarks/>
        public void CalculateAgeAsync(int year, int month, int day, object userState) {
            ...
            this.InvokeAsync("CalculateAge", new object[] {
                        year,
                        month,
                        day}, this.CalculateAgeOperationCompleted, userState);
        }
